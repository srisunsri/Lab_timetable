...
def product(request):
  ...
  tab_header = ["S.NO", "year/sem", "Date", "TimeDuration", "From Reg.No","To Reg.No","subcode", "labvenue", "Internal",
                "External"]
...
def renderdocx(request):
  doc = DocxTemplate("C:/Users/91909/PycharmProjects/pythonProject/my_timetable/text.docx")
  # you have to place your_docx_template.docx in the root of your project (same level as manage.py).
